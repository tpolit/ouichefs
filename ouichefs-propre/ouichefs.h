...
/* On ne veut que 4088 octets pour laisser 8 octets pour le next et le prev*/
#define OUICHEFS_MAX_INDEXS		  ((OUICHEFS_BLOCK_SIZE >> 2) - 2)
...
struct ouichefs_file_index_block {
	uint32_t blocks[OUICHEFS_MAX_INDEXS];
	uint32_t prev, next; /* Chainage des index_blocs */
};
